...
namespace memorama
{
	...
	//		button36.Enabled = true;
		...
		void ButtonClick(object sender, EventArgs e)
		{
			...
			label1.Text=("Movimientos "+mtotal);
				...
				if (ObtenerImagen(btn.Tag.ToString()) == ultimaImagenClickeada){
					...
					label3.Text=("Puntos "+cpunt1);
					if (cpunt1==18){
					MessageBox.Show("Ganaste" +Environment.NewLine + "Si quieres seguir jugando este nivel presiona reiniciar" +Environment.NewLine);
					}
		...
		void Form1PruebaLoad(object sender, EventArgs e)
		{
			mimemorama.IniciarMatrizImagenes();
			mimemorama.cargarMatrizImagenes();
			button1.Tag = "1";
