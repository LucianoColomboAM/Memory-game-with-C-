...
namespace memorama
{
	...
	public partial class Form2Jugadores : Form
	{
		...
		void Form2JugadoresLoad(object sender, EventArgs e)
		{	
			
			MessageBox.Show("Este es el modo hardore" +
			                "tienes un numero limitados de movimientos, suerte!");
			mimemorama.IniciarMatrizImagenes();
			mimemorama.cargarMatrizImagenes();
			button1.Tag = "1";
			button2.Tag = "2";
